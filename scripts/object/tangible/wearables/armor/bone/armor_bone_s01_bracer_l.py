...
def equip(core, actor, target):
        ...
        core.skillModService.addSkillMod(actor, 'kinetic', 600)
        core.skillModService.addSkillMod(actor, 'energy', 600)
        return
...
def unequip(core, actor, target):
        ...
        core.skillModService.deductSkillMod(actor, 'kinetic', 600)
        core.skillModService.deductSkillMod(actor, 'energy', 600)
        return