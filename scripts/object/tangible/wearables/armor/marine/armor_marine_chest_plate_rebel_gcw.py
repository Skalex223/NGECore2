...
def equip(core, actor, target):
        ...
        core.skillModService.addSkillMod(actor, 'kinetic', 921)
        core.skillModService.addSkillMod(actor, 'energy', 1321)
        return
...
def unequip(core, actor, target):
        ...
        core.skillModService.deductSkillMod(actor, 'kinetic', 921)
        core.skillModService.deductSkillMod(actor, 'energy', 1321)
        return