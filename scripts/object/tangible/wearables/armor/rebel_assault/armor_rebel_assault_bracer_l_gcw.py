...
def equip(core, actor, target):
        ...
        core.skillModService.addSkillMod(actor, 'kinetic', 661)
        core.skillModService.addSkillMod(actor, 'energy', 461)
        return
...
def unequip(core, actor, target):
        ...
        core.skillModService.deductSkillMod(actor, 'kinetic', 661)
        core.skillModService.deductSkillMod(actor, 'energy', 461)
        return