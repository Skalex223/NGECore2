...
def equip(core, actor, target):
        ...
        core.skillModService.addSkillMod(actor, 'kinetic', 1322)
        core.skillModService.addSkillMod(actor, 'energy', 922)
        return
...
def unequip(core, actor, target):
        ...
        core.skillModService.deductSkillMod(actor, 'kinetic', 1322)
        core.skillModService.deductSkillMod(actor, 'energy', 922)
        return