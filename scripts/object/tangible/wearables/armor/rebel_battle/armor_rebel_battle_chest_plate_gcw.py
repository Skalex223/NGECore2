...
def equip(core, actor, target):
        ...
        core.skillModService.addSkillMod(actor, 'kinetic', 1122)
        core.skillModService.addSkillMod(actor, 'energy', 1122)
        return
...
def unequip(core, actor, target):
        ...
        core.skillModService.deductSkillMod(actor, 'kinetic', 1122)
        core.skillModService.deductSkillMod(actor, 'energy', 1122)
        return