...
def equip(core, actor, target):
        ...
        core.skillModService.addSkillMod(actor, 'kinetic', 1088)
        core.skillModService.addSkillMod(actor, 'energy', 1088)
        return
...
def unequip(core, actor, target):
        ...
        core.skillModService.deductSkillMod(actor, 'kinetic', 1088)
        core.skillModService.deductSkillMod(actor, 'energy', 1088)
        return