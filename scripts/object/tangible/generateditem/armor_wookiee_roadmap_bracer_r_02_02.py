...
def setup(core, actor):
	...
	object = core.objectService.createObject('object/tangible/wearables/armor/kashyyykian_black_mtn/shared_armor_kashyyykian_black_mtn_bracer_r.iff', actor.getPlanet())
	object.setStfFilename('static_item_n')
	object.setStfName('armor_wookiee_roadmap_bracer_r_02_02')
	object.setDetailFilename('static_item_d')
	object.setDetailName('armor_wookiee_roadmap_bracer_r_02_02')
