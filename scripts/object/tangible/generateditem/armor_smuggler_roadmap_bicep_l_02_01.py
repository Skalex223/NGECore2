...
def setup(core, actor):
	...
	object = core.objectService.createObject('object/tangible/wearables/armor/tantel/shared_armor_tantel_skreej_bicep_l.iff', actor.getPlanet())
	object.setStfFilename('static_item_n')
	object.setStfName('armor_smuggler_roadmap_bicep_l_02_01')
	object.setDetailFilename('static_item_d')
	object.setDetailName('armor_smuggler_roadmap_bicep_l_02_01')
