...
def setup(core, actor):
	...
	object = core.objectService.createObject('object/tangible/wearables/armor/ithorian_guardian/shared_ith_armor_s02_bracer_r.iff', actor.getPlanet())
	object.setStfFilename('static_item_n')
	object.setStfName('armor_ithorian_roadmap_bracer_r_02_01')
	object.setDetailFilename('static_item_d')
	object.setDetailName('armor_ithorian_roadmap_bracer_r_02_01')
