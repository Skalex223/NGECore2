...
def setup(core, actor):
	...
	object = core.objectService.createObject('object/tangible/wearables/armor/composite/shared_armor_composite_bracer_l.iff', actor.getPlanet())
	object.setStfFilename('static_item_n')
	object.setStfName('armor_officer_roadmap_bracer_l_02_01')
	object.setDetailFilename('static_item_d')
	object.setDetailName('armor_officer_roadmap_bracer_l_02_01')
