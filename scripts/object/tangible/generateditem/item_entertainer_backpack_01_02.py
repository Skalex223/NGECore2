...
def setup(core, actor):
	...
	object = core.objectService.createObject('object/tangible/wearables/backpack/shared_backpack_s01.iff', actor.getPlanet())
	object.setStfFilename('static_item_n')
	object.setStfName('item_entertainer_backpack_01_02')
	object.setDetailFilename('static_item_d')
	object.setDetailName('item_entertainer_backpack_01_02')
