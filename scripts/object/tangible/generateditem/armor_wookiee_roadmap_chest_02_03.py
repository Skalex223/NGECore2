...
def setup(core, actor):
	...
	object = core.objectService.createObject('object/tangible/wearables/armor/kashyyykian_hunting/shared_armor_kashyyykian_hunting_chest_plate.iff', actor.getPlanet())
